...
Experiments are tested on Ascend 910* with mindspore 2.4.10 graph mode.

|  model name  |  scale  | cards  | batch size | resolution |  jit level  | ms/step | img/s |  map  |            recipe            |                                                weight                                                |
|  :--------:  |  :---:  |  :---: |   :---:    |   :---:    |    :---:    | :---: | :---:  |:-----:|            :---:             |:----------------------------------------------------------------------------------------------------:|
|    YOLOv11    |    N    |    1   |     128     |  640x640   |     O2      |  |  | 39.2% |    [yaml](./yolov11-n.yaml)    | [weights]() |
|    YOLOv11    |    S    |    1   |     128     |  640x640   |     O2      |  |  | 46.4% |    [yaml](./yolov11-s.yaml)    | [weights]() |
|    YOLOv11    |    M    |    1   |     108     |  640x640   |     O3      |  |  | 51.1% |    [yaml](./yolov11-m.yaml)    | [weights]() |
|    YOLOv11    |    L    |    2   |     64     |  640x640   |     O2      |  |  | 52.6% |    [yaml](./yolov11-l.yaml)    | [weights]() |
|    YOLOv11    |    X    |    3   |     43     |  640x640   |     O2      |  |  | 54.2% |    [yaml](./yolov11-x.yaml)    | [weights]() |
